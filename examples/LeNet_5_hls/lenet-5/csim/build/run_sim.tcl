...
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/nfs/app/Xilinx/Vivado_HLS/2014.4/lnx64/tools/fpo_v7_0
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/nfs/app/Xilinx/Vivado_HLS/2014.4/lnx64/tools/opencv
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/nfs/app/Xilinx/Vivado_HLS/2014.4/lnx64/tools/fft_v9_0
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/nfs/app/Xilinx/Vivado_HLS/2014.4/lnx64/tools/fir_v7_0
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ap_argv "LeNet-weights, 4.bmp"
### C sim ###
